...
export default function ApplicationDetail({applicationId, application, editable, api}) {
    ...
    return <div className='applicationDetail'>
                <h1>
                    {YTENV_APPLICATION_BASE_URL && (
                        <a title={YTENV_APPLICATION_LINK_TITLE} style={{textDecoration: "none", backgroundImage: "none"}} href={YTENV_APPLICATION_BASE_URL + applicationId}>
